module UserTestimonialHelper
  def user_testimonials
    return [
      ...
      {
        :message => "Shamin shared his stories with our Teach for Canada team and we took away so much from the interaction. Thank you Shamin, and thank you Time Auction for helping coordinate all of this!",
        :user_avatar => "https://s3-us-west-2.amazonaws.com/timeauction/landing/testimonials/johannes.jpg",
        :bidder_name => "Johannes Rebane",
        :auction_id => 9
      },
      {
        :message => "Dan was really friendly and shared a lot of advice and interesting stories. I think Time Auction is a brilliant idea and would love to participate in one again.",
        :user_avatar => "https://s3-us-west-2.amazonaws.com/timeauction/landing/testimonials/jeanny.png",
        :bidder_name => "Jeanny Yao",
        :auction_id => 24
      },
      {
        :message => "I thoroughly enjoyed my Time Auction and I highly recommend it to anyone. I am now connected with an amazing mentor - a precious gift. Thank you Zayna, and thank you Time Auction!",
        :user_avatar => "https://s3-us-west-2.amazonaws.com/timeauction/landing/testimonials/janet.jpg",
        :bidder_name => "Janet Law",
        :auction_id => 11
      },
      {
        :message => "Dan is a really inspiring person, who was actively interested in the work we were both doing. I hope he had at least half as good at time as we did.",
        :user_avatar => "https://s3-us-west-2.amazonaws.com/timeauction/landing/testimonials/karen.jpg",
        :bidder_name => "Karen Gomez",
        :auction_id => 24
      },
      {
        :message => "Mitchell has made me think about my career in a strategic manner. He has permanently changed the way I would portray myself in front of an opportunity.",
        :user_avatar => "https://s3-us-west-2.amazonaws.com/timeauction/landing/testimonials/xavier.jpg",
        :bidder_name => "Xavier Cheng",
        :auction_id => 42
      },
      {
        :message => "I’m very grateful to have become involved with Time Auction and their amazing team. I’ve met some very inspiring leaders in our community. Thank you Time Auction!",
        :user_avatar => "https://s3-us-west-2.amazonaws.com/timeauction/landing/testimonials/sharown.jpg",
        :bidder_name => "Sharown Poopalarajah",
        :auction_id => 34
      },
      {
        :message => "Meeting Steve was great. I learned so much about how to assess opportunities and the way Steve goes about growing his ventures. Terrific tour of Hipmunk too. Thanks Time Auction!",
        :user_avatar => "https://s3-us-west-2.amazonaws.com/timeauction/landing/testimonials/jack.jpg",
        :bidder_name => "Jack Liu",
        :auction_id => 16
      },
      {
      ...
      {
        :message => "The lunch with Rahul was awesome. He is truly inspiring and easygoing. We were having such a good conversation that before we realized it was already time to leave.",
        :user_avatar => "https://s3-us-west-2.amazonaws.com/timeauction/landing/testimonials/jackie.jpg",
        :bidder_name => "Jackie Cisneros",
        :auction_id => 7
      },
      {
        :message => "It was great to meet a bright individual who dedicated so much to our society. It was very beneficial to my life and my career. On top of that, it was a fantastic, tasty, and healthy lunch.",
        :user_avatar => "https://s3-us-west-2.amazonaws.com/timeauction/landing/testimonials/christopher.jpg",
        :bidder_name => "Christopher Lee",
        :auction_id => 13
      },
      {
        :message => "Wow. Just had lunch with Rahul Raj and it was extremely inspiring, useful, and moved me immensely. Just wonderful.",
        :user_avatar => "https://s3-us-west-2.amazonaws.com/timeauction/landing/testimonials/toni.jpeg",
        :bidder_name => "Toni De Mello",
        :auction_id => 7
      },
      {
        :message => "It was awesome meeting Sean - he was such a personable guy to talk to! I'm definitely looking forward to bidding on more auctions!",
